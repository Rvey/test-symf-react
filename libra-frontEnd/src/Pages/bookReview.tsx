  ...
  return (
    <div className="bg-white">
      {!book ? (
        ...
        <div className="pt-6 ">
          {/* book title */}
          <div className="max-w-2xl py-6 mx-auto mt-6 text-5xl font-bold lg:max-w-7xl">
            <h1>{book.title}</h1>
          </div>

          {/* Product info */}
          <div className="max-w-2xl px-4 pt-10 pb-16 mx-auto sm:px-6 lg:max-w-7xl lg:pt-16 lg:pb-24 lg:px-8 lg:gap-x-8 lg:gap-y-8">
            <div className="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8 mb-14">
              <h1 className="mb-4 text-2xl font-extrabold tracking-tight text-gray-900 sm:text-2xl">
                Author
              </h1>
            ...
            <div className="p-4 py-10 bg-gray-200 lg:pt-6 lg:pb-16 lg:col-start-1 lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
          ...
          {/* Review */}
          <div className="flex flex-col justify-between max-w-2xl px-4 pt-10 pb-16 mx-auto mt-4 sm:px-6 lg:max-w-7xl lg:pt-16 lg:pb-24 lg:px-8 lg:gap-x-8 lg:gap-y-8 ">
            <h2 className="mb-3 font-medium text-gray-900 text-md">
              Book Review
            </h2>
